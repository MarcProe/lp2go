...
public class ObjectTextView extends AutoResizeTextView {
    ...
    public ObjectTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ObjectTextView(Context context, AttributeSet attrs, int defStyleAttr) {
