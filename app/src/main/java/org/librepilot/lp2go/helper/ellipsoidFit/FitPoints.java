 ...
 * * changed ThreeSpacePoints to an interface to use the existing vector stored in the cube
 *  * implement getters for xyz
 * * change package name
 *
 */
...
public class FitPoints {
     ...
     */
    private RealVector solveSystem(List<? extends ThreeSpacePoint> points) {
    ...
    public String toString() {
        ...
        retval += " Center: " + center.toString();
        retval += " Radii: " + radii.toString();
