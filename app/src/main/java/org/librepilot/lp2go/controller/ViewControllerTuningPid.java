/*
 * @file   ViewControllerTuningPid.java
...
public class ViewControllerTuningPid extends ViewController implements View.OnClickListener {
    private final HashSet<ObjectTextView> mPidTexts;
    ...
    private final void privInit() {
        ...
        ObjectTextView txtPidRatePitchProportional =
                (ObjectTextView) ma.findViewById(R.id.txtRatePitchProportional);
        ...
        ObjectTextView txtPidRateYawProportional =
                (ObjectTextView) ma.findViewById(R.id.txtRateYawProportional);
        ...
        ObjectTextView txtPidRateRollIntegral =
                (ObjectTextView) ma.findViewById(R.id.txtRateRollIntegral);
        ...
        ObjectTextView txtPidRatePitchIntegral =
                (ObjectTextView) ma.findViewById(R.id.txtRatePitchIntegral);
        ...
        ObjectTextView txtPidRateYawIntegral =
                (ObjectTextView) ma.findViewById(R.id.txtRateYawIntegral);
        ...
        ObjectTextView txtPidRateRollDerivative =
                (ObjectTextView) ma.findViewById(R.id.txtRateRollDerivative);
        ...
        ObjectTextView txtPidRatePitchDerivative =
                (ObjectTextView) ma.findViewById(R.id.txtRatePitchDerivative);
        ...
        ObjectTextView txtPidRateYawDerivative =
                (ObjectTextView) ma.findViewById(R.id.txtRateYawDerivative);
        ...
        ObjectTextView txtPidRollProportional =
                (ObjectTextView) ma.findViewById(R.id.txtAttitudeRollProportional);
        ...
        ObjectTextView txtPidPitchProportional =
                (ObjectTextView) ma.findViewById(R.id.txtAttitudePitchProportional);
        ...
        ObjectTextView txtPidYawProportional =
                (ObjectTextView) ma.findViewById(R.id.txtAttitudeYawProportional);
        ...
        ObjectTextView txtPidRollIntegral =
                (ObjectTextView) ma.findViewById(R.id.txtAttitudeRollIntegral);
        ...
        ObjectTextView txtPidPitchIntegral =
                (ObjectTextView) ma.findViewById(R.id.txtAttitudePitchIntegral);
        ...
        ObjectTextView txtPidYawIntegral =
                (ObjectTextView) ma.findViewById(R.id.txtAttitudeYawIntegral);
        ...
        for (ObjectTextView ptv : mPidTexts) {
    ...
    public void enter(int view) {
        ...
        try {
            ...
            setImageViewSrc(R.id.imgPidRateStabLabel, R.drawable.text_rate_stabilization, 0.109f);
            setImageViewSrc(R.id.imgPidAttiStabLabel, R.drawable.text_attitude_stabilization, 0.095f);
            ...
            if (oTree != null) {
                ...
                for (ObjectTextView ptv : mPidTexts) {
                    try {
                        ...
                        VisualLog.e("Error parsing float: " + ptv.getField() + " " + ptv.getElement() +
